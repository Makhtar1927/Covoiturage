...
class RideListNotifier extends StateNotifier<List<Ride>> {
  ...
  void _loadDummyRides() {
    ...
    final driver1 = User(
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=Alexandre',
      rating: 4.9,
      isVerified: true,
      circle: 'Google Paris',
    );
    final driver2 = User(
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=Amandine',
      rating: 4.7,
      isVerified: true,
      circle: 'Sorbonne Université',
    );
    final driver3 = User(
      id: 'd3',
      name: 'Jean-Marc Lemaire',
      email: 'jeanmarc@gmail.com',
      avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=JeanMarc',
      rating: 4.5,
      isVerified: true,
      circle: 'Station F',
    );
    final driver4 = User(
      ...
      rating: 4.8,
      isVerified: true,
      circle: 'Université Paris-Saclay',
    );
    ...
    final dummyRides = [
      Ride(
        id: 'r1',
        driver: driver1,
        startPoint: 'Paris (Châtelet)',
        endPoint: 'Google Paris (8 Rue de Londres)',
        intermediateStops: ['Gare Saint-Lazare'],
        dateTime: now.add(const Duration(hours: 2)),
        price: 3.50,
        availableSeats: 3,
        totalSeats: 4,
        allowedCircles: ['Google Paris'],
        status: 'planned',
      ),
      Ride(
        id: 'r2',
        driver: driver2,
        startPoint: 'Créteil Soleil',
        endPoint: 'Sorbonne (Campus Jussieu)',
        intermediateStops: ['Nationale', 'Gare d\'Austerlitz'],
        dateTime: now.add(const Duration(hours: 4)),
        price: 2.00,
        availableSeats: 2,
        totalSeats: 3,
        allowedCircles: ['Sorbonne Université'],
        status: 'planned',
      ),
      Ride(
        id: 'r3',
        driver: driver3,
        startPoint: 'Gare de Lyon',
        endPoint: 'Station F (Halle Freyssinet)',
        intermediateStops: [],
        dateTime: now.add(const Duration(hours: 1)),
        price: 1.50,
        availableSeats: 8,
        totalSeats: 12,
        allowedCircles: ['Station F', 'Google Paris'],
        status: 'planned',
      ),
      Ride(
        id: 'r4',
        driver: driver4,
        startPoint: 'Massy Palaiseau Gare',
        endPoint: 'Campus Orsay (Bâtiment 300)',
        intermediateStops: ['Plateau de Saclay'],
        dateTime: now.add(const Duration(hours: 3)),
        price: 1.00,
        availableSeats: 28,
        totalSeats: 45,
        allowedCircles: ['Université Paris-Saclay'],
        status: 'planned',
      ),
    ];
...
class BookingNotifier extends StateNotifier<List<Booking>> {
  ...
  void _loadDummyBookings() {
    final passenger = User(
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=Lucas',
      rating: 4.6,
      isVerified: true,
      circle: 'Google Paris',
    );
